...
_INIT_PARAM_RANGE = 0.03             # 파라미터 랜덤 초기화 범위 (-_INIT_PARAM_RANGE ~ _INIT_PARAM_RANGE)
_INIT_LEARNING_RATE = 0.2          # 초기 학습률
_LEARNING_RATE_DECAY_FACTOR = 0.4   # 학습률에 대한 감쇠율
_BATCH_SIZE = 2                  # 한 배치 내 샘플 수
...
# ---- 여기부터 로그 파일에 기록 ----
VERSION = "v2"  # 버전명만 실행할 때마다 바꿔주면 됨
